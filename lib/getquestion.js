...
var url = 'http://api.stackexchange.com/2.2/search?order=desc&tagged=facebook-graph-api&sort=votes&site=stackoverflow&filter=withbody&pagesize=100';

//var url = 'http://api.stackexchange.com/2.2/search?order=desc&sort=votes&site=stackoverflow&filter=withbody&pagesize=100';

url = url + '&q=' + q + '&tagged=java-api';
console.log(url);
